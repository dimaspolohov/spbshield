...
add_action('wp_enqueue_scripts', 'style_rs_counter_theme', 11);
...
function storefront_rs_counter() {
    ...
    ?>
    <section class="rs-17">
        <div class="rs-counter <?php if ($bg_img) { ?> b-lazy <?php } ?>" <?php if ($bg_img) { ?> data-src="<?php echo esc_url($srcF); ?>" data-medium="<?php echo esc_url($src); ?>" data-small="<?php echo esc_url($srcm); ?>" style="background-size: cover;"<?php } ?>>
            <div class="container">
                <div class="row">
                    ...
                    <div class="timer">
                        ...
                        <script>
                            (function() {
                                ...
                                _t.src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/js/timer.min.js";

                                var msUTC = Date.parse("<?php echo esc_attr(date_i18n($dateformatstring, $unixtimestamp)); ?>T<?php echo esc_attr($finish_time); ?>:00.000Z");
