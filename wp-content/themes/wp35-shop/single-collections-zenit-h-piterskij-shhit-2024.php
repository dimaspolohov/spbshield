		...
		<div class="rs-store__wrapper">
			<div class="rs-store__content">
				<div class="store-content">
										...
										<div class="store-goods__slide">
											<article class="goods-card">	
												<div class="goods-card__wrapper">
													...
													<h5 class="goods-card__title"><?=get_the_title($product_id)?></h5>
					...
					<?php endif; ?>
					<br/><br/>
					<a href="https://www.spbshield.ru/shop/zenit-x-piterskij-shhit-2024/" class="rs-btn _black-border-btn">Перейти ко всем товарам коллекции</a>
				</div>
			</div>
			<div class="rs-store__gallery">
				<div class="store-gallery">
					<a href="<?=$site_url?>/zenit/img/1@2x.jpg" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/1.jpg">
							<img src="<?=$site_url?>/zenit/img/1@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/2@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/2.jpg">
							<img src="<?=$site_url?>/zenit/img/2@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/3@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/3.jpg">
							<img src="<?=$site_url?>/zenit/img/3@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/4@2x.jpg" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/4.jpg">
							<img src="<?=$site_url?>/zenit/img/4@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/5@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/5.jpg">
							<img src="<?=$site_url?>/zenit/img/5@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/6@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/6.jpg">
							<img src="<?=$site_url?>/zenit/img/6@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/7@2x.jpg" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/7.jpg">
							<img src="<?=$site_url?>/zenit/img/7@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/08@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/08.jpg">
							<img src="<?=$site_url?>/zenit/img/08@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/09@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/09.jpg">
							<img src="<?=$site_url?>/zenit/img/09@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/10@2x.jpg" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/10.jpg">
							<img src="<?=$site_url?>/zenit/img/10@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/11@2x.jpg" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/11.jpg">
							<img src="<?=$site_url?>/zenit/img/11@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/12@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/12.jpg">
							<img src="<?=$site_url?>/zenit/img/12@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/13@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/13.jpg">
							<img src="<?=$site_url?>/zenit/img/13@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/14@2x.jpg" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/14.jpg">
							<img src="<?=$site_url?>/zenit/img/14@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/15@2x.jpg" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/15.jpg">
							<img src="<?=$site_url?>/zenit/img/15@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/16@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/16.jpg">
							<img src="<?=$site_url?>/zenit/img/16@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/17@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/17.jpg">
							<img src="<?=$site_url?>/zenit/img/17@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/18@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/18.jpg">
							<img src="<?=$site_url?>/zenit/img/18@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/19@2x.jpg" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/19.jpg">
							<img src="<?=$site_url?>/zenit/img/19@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/zenit/img/20@2x.jpg" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/zenit/img/20.jpg">
							<img src="<?=$site_url?>/zenit/img/20@2x.jpg" loading="lazy" alt="">
						</picture>
					</a>
				</div>
			</div>
