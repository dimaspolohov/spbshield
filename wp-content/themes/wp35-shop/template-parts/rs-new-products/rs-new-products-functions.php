...
// Enqueue new products block styles
add_action( 'wp_enqueue_scripts', 'style_rs_new_products_theme' );
									...
									<div class="product-item">
										<div class="product">
											<div class="product-image">
												<div class="quickview">
													<a data-id="<?php echo absint( $post_id ); ?>" class="btn btn-xs btn-quickview" href="#" data-path="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>" data-target="#new-product-details-modal" data-toggle="modal">Быстрый просмотр</a>
												</div>
