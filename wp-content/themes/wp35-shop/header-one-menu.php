...
<link rel="stylesheet" href="<?php echo esc_url( get_stylesheet_directory_uri() . '/template-parts/rs-page-one-menu/css/rs-page-one-menu.css' ); ?>">
...
<div id="page" class="hfeed site">
	...
	<div class="rs-one-menu">
		<header id="masthead" style="<?php storefront_header_styles(); ?>" >
			...
			add_action('storefront_header', 'storefront_primary_navigation_child_right', 55);
