...
<link rel="stylesheet" href="<?php echo esc_url($site_url . '/css/pages/media/rs-banner-video.css?v=' . filemtime( $site_path . 'css/pages/media/rs-banner-video.css' )); ?>">
<script src="<?php echo esc_url($site_url . '/js/pages/media/rs-banner-video.js'); ?>" defer></script>
...
<?php switch(get_field('otobrazhenie_v_kataloge')) {
	case 'Видео':
...
<section class="rs-banner-video rs-banner-video-2">
	<div class="rs-banner-video_container">
		...
		<div class="rs-banner-video__wrapper rs-banner-video__bg__autoh rs-banner-video__bg__paddingh">
			<a href="<?php the_permalink(); ?>" id="video-container<?php echo $rand = rand(1000,9999); ?>" class="rs-banner-video__bg">
				<video class="bgvideo js-bgvideo" loop="" autoplay="" muted="" poster="<?php echo esc_url(get_field('prevyu_video')['url']); ?>">
					<source data-src="<?php echo esc_url($video_webm); ?>" src="<?php echo esc_url($video_webm); ?>" type="video/webm">
					<source data-src="<?php echo esc_url($video); ?>" src="<?php echo esc_url($video); ?>" type="video/mp4">
				</video>
			</a>
		</div>
		<div class="rs-banner-video__about">
			<div class="rs-banner-video__about_body">
				<a href="<?php the_permalink(); ?>" class="xxl-regular-title"><?php
        ...
        <script>
            add_video<?php echo $rand; ?>();
            function add_video<?php echo $rand; ?>(){
                let videoBlock=document.querySelector('#video-container<?php echo $rand; ?>');
                if(window.innerWidth >= 992) {
                    videoBlock.innerHTML = '<video class="bgvideo js-bgvideo" loop="" autoplay="" muted="" poster="<?php echo esc_url(get_field('prevyu_video')['url']); ?>"><source  src="<?php echo esc_url($video_webm); ?>" type="video/webm"><source  src="<?php echo esc_url($video); ?>" type="video/mp4"></video>'
                } else {
                    videoBlock.innerHTML ='<img src="<?php echo esc_url(get_field('prevyu_video')['url']); ?>"  alt="">'
                }
            };
        </script>
	</div>
					...
					<div class="rs-banner-video__swiper swiper-wrapper">
						...
						<div class="rs-banner-video__slide swiper-slide">
							<div class="rs-banner-video__img">
								<img class="img-desktop" src="<?php echo esc_url(get_sub_field('izobrazhenie')['url']); ?>" alt="">
								<img class="img-mobile" src="<?php echo esc_url(get_sub_field('izobrazhenie_mob')['url']); ?>" alt="">
							</div>
						</div>
						<?php endwhile; ?>
					</div>
					...
					<div class="rs-banner-video__swiper swiper-wrapper">
						...
						<div class="rs-banner-video__slide swiper-slide">
							...
							<div class="rs-banner-video__text">
								<h2 class="large-title"><?php echo esc_html($title); ?></h2>
								<p class="large-text"><?php echo esc_html($description); ?></p>
...
<section class="rs-banner-video rs-banner-video-3">
	<div class="rs-banner-video_container">
		<div class="rs-banner-video__about">
			<div class="rs-banner-video__about_body">
				<h3 class="xxl-regular-title"><?php
				$title = get_field('zagolovok_v_kataloge');
				if(!$title||$title=='') $title = get_the_title();
				echo esc_html($title);				
				?></h3>
...
<?php } else {?>
	<?php if($index==4) { ?>
	<link rel="stylesheet" href="<?php echo esc_url($site_url . '/css/pages/collection/rs-old-collection.css?v=' . filemtime( $site_path . 'css/pages/collection/rs-old-collection.css' )); ?>">
	<script src="<?php echo esc_url($site_url . '/js/pages/collection/rs-old-collection.js?v=' . filemtime( $site_path . 'js/pages/collection/rs-old-collection.js' )); ?>" defer></script>
