...
<div class="rs-cart rs-checkout">
	<div class="container">
		...
		<form name="checkout" method="post" class="checkout woocommerce-cart-form woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
			<div class="cart-left">
