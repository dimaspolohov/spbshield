			...
			<div class="cart-left">
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							?>
								<tr class="cart-product woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
									...
									<td class="product-thumbnail cart-product-thumb">
										<?php
									...
									// Meta data.
									echo wc_get_formatted_cart_item_data__alt( $cart_item ); // PHPCS: XSS ok.
								...
								<td class="delete product-remove">
									<?php
				...
				<div class="cart-footer">
					<div class="box-footer">
						<div class="pull-left">
							<button type="submit" class="rs-btn _border-btn _black-border-btn" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>">
								<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.06189 10C1.02104 9.67241 1 9.33866 1 9C1 4.58172 4.58172 1 9 1C11.5006 1 13.7332 2.14727 15.2002 3.94416M16.9381 8C16.979 8.32759 17 8.66134 17 9C17 13.4183 13.4183 17 9 17C6.61061 17 4.46589 15.9525 3 14.2916M6 14H3V14.2916M15.2002 1V3.94416M15.2002 3.94416V3.99993L12.2002 4M3 17V14.2916" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><?php esc_html_e( 'Update cart', 'woocommerce' ); ?>
							</button>
						</div>
					</div>
				</div>
