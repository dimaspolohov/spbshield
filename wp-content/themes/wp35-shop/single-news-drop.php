...
<div class="rs-store" >	
    <div class="rs-store__container">
        <div class="rs-store__wrapper" style="padding-top:60px;">
            <div class="rs-store__content">
                <div class="store-content">
                    <div class="store-content__about">
                        <div class="store-about">
                            <h2 class="store-about__title"><b>Питерский Щит x TOP DOG</b></h2>
                            <p class="store-about__text">Встречайте! Долгожданная коллекция «Питерский Щит x TOP DOG» уже доступна для заказа и к покупке в розничном магазине на Гороховой, 49.</p>
                        </div>
                    </div>
                    ...
                    <?php endif; ?>
                    <br/><br/>
                    <a href="/shop/new-drop/" class="rs-btn _black-border-btn" style="margin-top:80px;">Перейти ко всем товарам дропа</a>
                </div>
            </div>
