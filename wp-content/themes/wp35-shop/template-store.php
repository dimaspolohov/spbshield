        ...
        <section class="rs-store">
            <div class="rs-store_container">
                <div class="rs-store__contact">
                    ...
                    <div class="rs-store__contact_flex_second">
                        <div class="rs-store__contact_list">
                            <div class="rs-store__contact_item">
                                        ...
                                        <div class="form-block">
                                            ...
                                            <div class="form-field">
                                                <label class="input-file rs-input">
                                                    ...
                                                    <span><?php _e('Attach file','storefront')?></span>
                                                    <span class="default hidden"><?php _e('Attach file','storefront')?></span>
                                                    <span class="multi hidden"> <?php _e('files','storefront')?></span>
                                                </label>
