...
// Подключить стили для блока Распродажа
    add_action( 'wp_print_scripts', 'style_rs_onsale_theme');
						...
						<div class="product-item">
							<div class="product">
								<div class="product-image">
									<div class="quickview">
										<a data-id="<?=$loop->post->ID?>" class="btn btn-xs btn-quickview" href="#"  data-path="<?=get_stylesheet_directory_uri(); ?>" data-target="#onsale-product-details-modal" data-toggle="modal">Быстрый просмотр</a>
									</div>
