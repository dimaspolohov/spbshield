...
add_action( 'wp_enqueue_scripts', 'style_rs_contactus_theme', 12 );
...
?>
<section class="rs-17">
	<div class="rs-contactus <?php if ( $bg_img ) { ?> b-lazy <?php } ?>" id="block-feedback" <?php if ( $bg_img ) { ?> data-src="<?php echo esc_url( $srcF ); ?>" data-medium="<?php echo esc_url( $src ); ?>" data-small="<?php echo esc_url( $srcm ); ?>" style="background-size: cover;"<?php } ?>>
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
