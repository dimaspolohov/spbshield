...
<?php endif; ?>
<br/><br/>
					<a href="https://www.spbshield.ru/shop/gothica/" class="rs-btn _black-border-btn">Перейти ко всем товарам коллекции</a>

				</div>
			</div>
			<!--div class="rs-store__gallery">
				<div  class="store-video" target="_blank">
					<img src="<?=$site_url?>/drop/opt/1.jpg" alt=""> 
				</div-->
<div class="store-gallery">


<a href="<?=$site_url?>/drop/opt/1.JPG" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/1.JPG">
        <img src="<?=$site_url?>/drop/opt/1.JPG" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/2.jpg" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/2.jpg">
        <img src="<?=$site_url?>/drop/opt/2.jpg" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/3.JPG" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/3.JPG">
        <img src="<?=$site_url?>/drop/opt/3.JPG" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/4.JPG" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/4.JPG">
        <img src="<?=$site_url?>/drop/opt/4.JPG" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/5.JPG" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/5.JPG">
        <img src="<?=$site_url?>/drop/opt/5.JPG" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/6.JPG" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/6.JPG">
        <img src="<?=$site_url?>/drop/opt/6.JPG" loading="lazy" alt="">
    </picture>
</a>



<a href="<?=$site_url?>/drop/opt/7.jpg" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/7.jpg">
        <img src="<?=$site_url?>/drop/opt/7.jpg" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/8.JPG" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/8.JPG">
        <img src="<?=$site_url?>/drop/opt/8.JPG" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/9.JPG" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/9.JPG">
        <img src="<?=$site_url?>/drop/opt/9.JPG" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/10.JPG" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/10.JPG">
        <img src="<?=$site_url?>/drop/opt/10.JPG" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/11.JPG" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/11.JPG">
        <img src="<?=$site_url?>/drop/opt/11.JPG" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/12.jpg" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/12.jpg">
        <img src="<?=$site_url?>/drop/opt/12.jpg" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/13.JPG" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/13.JPG">
        <img src="<?=$site_url?>/drop/opt/13.JPG" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/14.JPG" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/14.JPG">
        <img src="<?=$site_url?>/drop/opt/14.JPG" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/15.jpg" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/15.jpg">
        <img src="<?=$site_url?>/drop/opt/15.jpg" loading="lazy" alt="">
    </picture>
</a>

<a href="<?=$site_url?>/drop/opt/16.jpg" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/16.jpg">
        <img src="<?=$site_url?>/drop/opt/16.jpg" loading="lazy" alt="">
    </picture>
</a>
<a href="<?=$site_url?>/drop/opt/17.jpg" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/17.jpg">
        <img src="<?=$site_url?>/drop/opt/17.jpg" loading="lazy" alt="">
    </picture>
</a>
<a href="<?=$site_url?>/drop/opt/18.jpg" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/18.jpg">
        <img src="<?=$site_url?>/drop/opt/18.jpg" loading="lazy" alt="">
    </picture>
</a>
 <a href="<?=$site_url?>/drop/opt/19.jpg" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/19.jpg">
        <img src="<?=$site_url?>/drop/opt/19.jpg" loading="lazy" alt="">
    </picture>
</a>
<a href="<?=$site_url?>/drop/opt/20.jpg" data-fancybox class="store-gallery__item store-gallery__item_wide">
    <picture>
        <source media="(max-width: 1024px)" srcset="<?=$site_url?>/drop/opt/20.jpg">
        <img src="<?=$site_url?>/drop/opt/20.jpg" loading="lazy" alt="">
    </picture>
</a>
