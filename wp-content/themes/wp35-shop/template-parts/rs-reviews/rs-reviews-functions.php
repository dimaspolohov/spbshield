...
function rename_posts_labels_review( $labels ){
	...
	$new = array(
		...
		'menu_name'             => 'Отзывы',
		'name_admin_bar'        => 'Отзыв', // "Add New" menu item
	);
...
<!-- rs-reviews -->
<section class="rs-17">
	<div class="rs-reviews b-lazy" data-src="<?php echo esc_url( $block_img['url'] ); ?>" style="background-size: cover;">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
				...
				<div class="col-xs-12">
					<div class="reviews-slider owl-carousel" data-nekoanim="fadeInUp" data-nekodelay="400">
						<?php
						$reviews_query = new WP_Query( array( 'post_type' => 'review', 'posts_per_page' => 10 ) );
						...
						?>
								<div class="reviews-item">
									<a href="<?php the_permalink(); ?>" class="reviews-content">
										...
										<div class="reviews-name"><?php echo esc_html( $author ); ?></div>
									</a>
									<div class="reviews-img">
										<a href="<?php the_permalink(); ?>">
											<img src="<?php echo esc_url( $img['url'] ); ?>" alt="review" class="img-responsive">
										</a>
									</div>
								</div>
						<?php endwhile; ?>
