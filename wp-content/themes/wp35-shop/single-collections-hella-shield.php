		...
		<div class="rs-store__wrapper">
			<div class="rs-store__content">
				<div class="store-content">
					...
					<?php endif; ?>
					<br/><br/>
					<a href="https://www.spbshield.ru/shop/hellashield/" class="rs-btn _black-border-btn">Перейти ко всем товарам коллекции</a>
				</div>
			</div>
			<div class="rs-store__gallery">
				<div class="store-gallery">
					<a href="<?=$site_url?>/hella-shield/img/1.JPG" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/1.JPG">
							<img src="<?=$site_url?>/hella-shield/img/1.JPG" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/hella-shield/img/2.JPG" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/2.JPG">
							<img src="<?=$site_url?>/hella-shield/img/2.JPG" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/hella-shield/img/3.JPG" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/3.JPG">
							<img src="<?=$site_url?>/hella-shield/img/3.JPG" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/hella-shield/img/4.JPG" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/4.JPG">
							<img src="<?=$site_url?>/hella-shield/img/4.JPG" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/hella-shield/img/5.JPG" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/5.JPG">
							<img src="<?=$site_url?>/hella-shield/img/5.JPG" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/hella-shield/img/6.JPG" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/6.JPG">
							<img src="<?=$site_url?>/hella-shield/img/6.JPG" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/hella-shield/img/7.JPG" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/7.JPG">
							<img src="<?=$site_url?>/hella-shield/img/7.JPG" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/hella-shield/img/8.JPG" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/8.JPG">
							<img src="<?=$site_url?>/hella-shield/img/8.JPG" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/hella-shield/img/9.JPG" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/9.JPG">
							<img src="<?=$site_url?>/hella-shield/img/9.JPG" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/hella-shield/img/10.JPG" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/10.JPG">
							<img src="<?=$site_url?>/hella-shield/img/10.JPG" loading="lazy" alt="">
						</picture>
					</a>



					<a href="<?=$site_url?>/hella-shield/img/12.JPG" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/12.JPG">
							<img src="<?=$site_url?>/hella-shield/img/12.JPG" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/hella-shield/img/13.JPG" data-fancybox class="store-gallery__item">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/13.JPG">
							<img src="<?=$site_url?>/hella-shield/img/13.JPG" loading="lazy" alt="">
						</picture>
					</a>

					<a href="<?=$site_url?>/hella-shield/img/14.JPG" data-fancybox class="store-gallery__item ">
						<picture>
							<source media="(max-width: 1024px)" srcset="<?=$site_url?>/hella-shield/img/14.JPG">
							<img src="<?=$site_url?>/hella-shield/img/14.JPG" loading="lazy" alt="">
						</picture>
					</a>
